...
const About = ({ islogged, setIsLogged }) => {
  return (
    <div>
          ...
          <div className="carousel-item active">
            ...
            <div className="carousel-caption d-none d-md-block">
              ...
              <p className="p">
                ...
                competitive and organized, that aims to use, maintain, or
                improve physical ability and skills Sport pertains to any form
                of physical activity or game, often competitive and organized,
                that aims to use, maintain, or improve physical ability and
                skills while providing enjoyment to participants and, in some
                cases, entertainment to spectators. Sports can, through casual
                or organized participation, improve participants' physical
                health.
              </p>
            </div>
          </div>
